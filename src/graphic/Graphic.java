...
public class Graphic {
    ...
    public void mainMenu() {
        ...
        GraphicFunctions.setLabel(hoTen, contentPane, "Đặng Lê Quốc Bảo - Nguyễn Hữu Phước", 70, 10, 300, 50);
        ...
        GraphicFunctions.setButton(DauSach, contentPane, "ĐẦU SÁCH", 550, 120, 200, 50);
        ...
        GraphicFunctions.setButton(Thoat, contentPane, "THOÁT", 120, 250, 200, 50);
    ...
    public void docGia() {
        ...
        GraphicFunctions.setButton(ThemDocGia, contentPane, "THÊM ĐỘC GIẢ", 350, 50, 200, 50);
        ...
        GraphicFunctions.setButton(DanhSachDocGia, contentPane, "DANH SÁCH ĐỘC GIẢ", 350, 120, 200, 50);
        ...
        GraphicFunctions.setButton(XoaDocGia, contentPane, "XÓA ĐỘC GIẢ", 350, 190, 200, 50);
        ...
        GraphicFunctions.setButton(ChinhSuaDocGia, contentPane, "CHỈNH SỬA ĐỘC GIẢ ", 350, 260, 200, 50);
        ...
        GraphicFunctions.setButton(QuayLai, contentPane, "QUAY LẠI", 350, 330, 200, 50);
